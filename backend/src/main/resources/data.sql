...
VALUES
        ...
        (4, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/527698', 'COMPLETED', '{"날짜": "25-02-43 11:30", "업체명": "루비웨딩센터", "홀명": "루비웨딩센터 홀", "위치": "서울특별시 용산구", "가능 날짜": "2025-02-43 가능", "홀_유형": "컨벤션홀", "최대인원": "300명", "대관료": "100만 원", "예식_방식": "동시예식", "식사_형태": "뷔페", "1인당_식사_비용": "6만원", "최소_보장_인원": "200명", "포함_서비스": ["고급 테이블 장식", "플라워 장식", "조명 연출"], "계약금": "25만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["플래너 이용권 10% 할인", "주차 100대 무료", "사회자 10% 할인"]}', 1, 28),
        (5, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/168475', 'COMPLETED', '{"날짜": "25-03-50 13:30", "업체명": "엘레강스웨딩홀", "홀명": "엘레강스웨딩홀 홀", "위치": "서울특별시 강남구", "가능 날짜": "2025-03-50 가능", "홀_유형": "채플홀", "최대인원": "250명", "대관료": "300만 원", "예식_방식": "분리예식", "식사_형태": "뷔페", "1인당_식사_비용": "10만원", "최소_보장_인원": "100명", "포함_서비스": ["음악", "조명 연출", "리프트 입장"], "계약금": "75만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["플래너 이용권 10% 할인", "평일 예식 10% 할인", "혼주 식사 제공", "사회자 10% 할인"]}', 1, 29),
        (6, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/853097', 'COMPLETED', '{"날짜": "25-03-27 11:00", "업체명": "플로렌스하우스", "홀명": "플로렌스하우스 홀", "위치": "서울특별시 강남구", "가능 날짜": "2025-03-27 가능", "홀_유형": "채플홀", "최대인원": "300명", "대관료": "150만 원", "예식_방식": "2부예식", "식사_형태": "코스식사", "1인당_식사_비용": "10만원", "최소_보장_인원": "200명", "포함_서비스": ["웨딩 플래너 서비스", "리프트 입장"], "계약금": "38만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["주차 100대 무료", "평일 예식 10% 할인", "사회자 10% 할인"]}', 11, 26),
        (7, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/345449', 'COMPLETED', '{"날짜": "25-03-34 13:30", "업체명": "벨라루체", "홀명": "벨라루체 홀", "위치": "서울특별시 용산구", "가능 날짜": "2025-03-34 가능", "홀_유형": "컨벤션홀", "최대인원": "350명", "대관료": "100만 원", "예식_방식": "분리예식", "식사_형태": "한상차림", "1인당_식사_비용": "8만원", "최소_보장_인원": "150명", "포함_서비스": ["라이브 연주", "조명 연출"], "계약금": "25만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["혼주 식사 제공", "스드메 패키지 10% 할인", "플래너 이용권 10% 할인"]}', 11, 25),
        (8, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/328343', 'COMPLETED', '{"날짜": "25-03-41 11:00", "업체명": "아모르컨벤션", "홀명": "아모르컨벤션 홀", "위치": "서울특별시 강남구", "가능 날짜": "2025-03-41 가능", "홀_유형": "채플홀", "최대인원": "300명", "대관료": "100만 원", "예식_방식": "분리예식", "식사_형태": "코스식사", "1인당_식사_비용": "6만원", "최소_보장_인원": "150명", "포함_서비스": ["웨딩 플래너 서비스", "플라워 장식"], "계약금": "25만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["주차 100대 무료", "스드메 패키지 10% 할인", "혼주 식사 제공"]}', 11, 24),
        (9, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/128127', 'COMPLETED', '{"날짜": "25-04-48 12:00", "업체명": "더화이트채플", "홀명": "더화이트채플 홀", "위치": "서울특별시 서초구", "가능 날짜": "2025-04-48 가능", "홀_유형": "채플홀", "최대인원": "300명", "대관료": "300만 원", "예식_방식": "2부예식", "식사_형태": "뷔페", "1인당_식사_비용": "8만원", "최소_보장_인원": "100명", "포함_서비스": ["조명 연출", "리프트 입장", "음악"], "계약금": "75만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["평일 예식 10% 할인", "주차 100대 무료", "3개월 내 계약시 대관료 10% 할인", "플래너 이용권 10% 할인"]}', 1, 30),
        (10, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/412081', 'COMPLETED', '{"날짜": "25-04-25 13:00", "업체명": "로얄가든웨딩홀", "홀명": "로얄가든웨딩홀 홀", "위치": "서울특별시 서초구", "가능 날짜": "2025-04-25 가능", "홀_유형": "가든", "최대인원": "150명", "대관료": "150만 원", "예식_방식": "분리예식", "식사_형태": "한상차림", "1인당_식사_비용": "5만원", "최소_보장_인원": "100명", "포함_서비스": ["고급 테이블 장식", "조명 연출"], "계약금": "38만 원", "환불_규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["사회자 10% 할인", "평일 예식 10% 할인", "플래너 이용권 10% 할인", "주차 100대 무료"]}', 1, 31);
INSERT INTO audio_summaries (audio_summary_id, original_file_url, status, summary_result, customer_id, consultation_id)
VALUES
        (11, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/520690', 'COMPLETED', '{"날짜": "2025-02-22 13:30", "업체명": "화이트스튜디오", "패키지": "프리미엄 패키지", "촬영 스타일": "모던", "사진 장수": "60장", "촬영 시간": "4시간", "드레스 체인지 횟수": "2회", "메이크업": "신랑+신부", "앨범": "커스텀 앨범", "패키지 비용": "300만 원", "계약금": "60만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["스튜디오 소품 무료 제공", "리허설 촬영 무료", "야외 촬영 옵션 제공", "보정 서비스 포함"]}', 1, 39),
        (12, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/583351', 'COMPLETED', '{"날짜": "2025-02-29 13:30", "업체명": "라비앙스튜디오", "패키지": "스페셜 패키지", "촬영 스타일": "클래식", "사진 장수": "20장", "촬영 시간": "5시간", "드레스 체인지 횟수": "4회", "메이크업": "신부 단독", "앨범": "커스텀 앨범", "패키지 비용": "200만 원", "계약금": "40만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["가족 사진 추가 무료", "촬영 원본 제공", "스튜디오 소품 무료 제공"]}', 1, 40),
        (13, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/539619', 'COMPLETED', '{"날짜": "2025-02-36 11:30", "업체명": "메이플스튜디오", "패키지": "스페셜 패키지", "촬영 스타일": "빈티지", "사진 장수": "30장", "촬영 시간": "4시간", "드레스 체인지 횟수": "1회", "메이크업": "신랑+신부", "앨범": "기본 앨범", "패키지 비용": "150만 원", "계약금": "30만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["촬영 원본 제공", "가족 사진 추가 무료", "앨범 업그레이드 할인", "스튜디오 소품 무료 제공"]}', 1, 41),
        (14, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/747366', 'COMPLETED', '{"날짜": "2025-02-43 13:00", "업체명": "루체스튜디오", "패키지": "기본 패키지", "촬영 스타일": "내추럴", "사진 장수": "20장", "촬영 시간": "4시간", "드레스 체인지 횟수": "2회", "메이크업": "신부 단독", "앨범": "커스텀 앨범", "패키지 비용": "300만 원", "계약금": "60만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["가족 사진 추가 무료", "SNS 홍보용 사진 무료 제공", "보정 서비스 포함"]}', 1, 42),
        (15, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/569789', 'COMPLETED', '{"날짜": "2025-03-50 11:30", "업체명": "더브라이드스튜디오", "패키지": "럭셔리 패키지", "촬영 스타일": "클래식", "사진 장수": "30장", "촬영 시간": "4시간", "드레스 체인지 횟수": "2회", "메이크업": "신랑+신부", "앨범": "고급 앨범", "패키지 비용": "150만 원", "계약금": "30만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["드레스 피팅 1회 무료", "리허설 촬영 무료", "가족 사진 추가 무료", "보정 서비스 포함"]}', 1, 43),
        (16, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/507334', 'COMPLETED', '{"날짜": "2025-03-27 13:00", "업체명": "블루문스튜디오", "패키지": "프리미엄 패키지", "촬영 스타일": "빈티지", "사진 장수": "60장", "촬영 시간": "4시간", "드레스 체인지 횟수": "3회", "메이크업": "가족 포함", "앨범": "고급 앨범", "패키지 비용": "200만 원", "계약금": "40만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["가족 사진 추가 무료", "앨범 업그레이드 할인", "스튜디오 소품 무료 제공", "야외 촬영 옵션 제공"]}', 11, 38),
        (17, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/864958', 'COMPLETED', '{"날짜": "2025-03-34 13:30", "업체명": "벨라비스튜디오", "패키지": "기본 패키지", "촬영 스타일": "빈티지", "사진 장수": "50장", "촬영 시간": "2시간", "드레스 체인지 횟수": "3회", "메이크업": "신랑+신부", "앨범": "기본 앨범", "패키지 비용": "300만 원", "계약금": "60만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["스튜디오 소품 무료 제공", "보정 서비스 포함", "가족 사진 추가 무료"]}', 11, 36),
        (18, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/411547', 'COMPLETED', '{"날짜": "2025-03-41 12:00", "업체명": "로얄스튜디오", "패키지": "스페셜 패키지", "촬영 스타일": "클래식", "사진 장수": "60장", "촬영 시간": "4시간", "드레스 체인지 횟수": "2회", "메이크업": "신랑+신부", "앨범": "고급 앨범", "패키지 비용": "100만 원", "계약금": "20만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["특정 날짜 예약 시 할인 혜택", "드레스 피팅 1회 무료", "야외 촬영 옵션 제공", "가족 사진 추가 무료"]}', 11, 37);
...
INSERT INTO audio_summaries (audio_summary_id, original_file_url, status, summary_result, customer_id, consultation_id)
VALUES
        (19, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/237613', 'COMPLETED', '{"날짜": "2025-02-22 11:30", "업체명": "화이트엘리자베스", "위치": "서울특별시 용산구", "패키지": "프리미엄 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 1벌", "피팅 횟수": "3회", "메이크업 포함 여부": "미포함", "패키지 비용": "180만 원", "계약금": "36만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["드레스 소품 무료 제공", "특정 날짜 예약 시 할인 혜택", "보정 서비스 포함", "드레스 피팅 시 헤어 메이크업 무료"]}', 1, 54),
        (20, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/762980', 'COMPLETED', '{"날짜": "2025-02-29 12:30", "업체명": "라비앙로즈", "위치": "서울특별시 강남구", "패키지": "럭셔리 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 3벌", "피팅 횟수": "3회", "메이크업 포함 여부": "미포함", "패키지 비용": "100만 원", "계약금": "20만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["앨범 업그레이드 할인", "드레스 소품 무료 제공", "드레스 피팅 시 헤어 메이크업 무료", "야외 촬영 옵션 제공"]}', 1, 55),
        (21, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/919580', 'COMPLETED', '{"날짜": "2025-02-36 12:30", "업체명": "메이플브라이드", "위치": "서울특별시 중구", "패키지": "스페셜 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 3벌", "피팅 횟수": "2회", "메이크업 포함 여부": "포함", "패키지 비용": "160만 원", "계약금": "32만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["드레스 피팅 시 헤어 메이크업 무료", "드레스 소품 무료 제공", "보정 서비스 포함", "특정 날짜 예약 시 할인 혜택"]}', 1, 56),
        (22, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/552698', 'COMPLETED', '{"날짜": "2025-02-43 13:30", "업체명": "루체웨딩", "위치": "서울특별시 용산구", "패키지": "기본 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 1벌", "피팅 횟수": "4회", "메이크업 포함 여부": "포함", "패키지 비용": "140만 원", "계약금": "28만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["특정 날짜 예약 시 할인 혜택", "앨범 업그레이드 할인", "촬영 원본 제공"]}', 1, 57),
        (23, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/455746', 'COMPLETED', '{"날짜": "2025-03-50 11:30", "업체명": "더브라이드갤러리", "위치": "서울특별시 용산구", "패키지": "프리미엄 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 2벌", "피팅 횟수": "3회", "메이크업 포함 여부": "포함", "패키지 비용": "160만 원", "계약금": "32만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["촬영 원본 제공", "야외 촬영 옵션 제공", "드레스 피팅 시 헤어 메이크업 무료"]}', 1, 58),
        (24, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/720880', 'COMPLETED', '{"날짜": "2025-03-27 12:00", "업체명": "블루문드레스", "위치": "서울특별시 용산구", "패키지": "기본 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 2벌", "피팅 횟수": "4회", "메이크업 포함 여부": "미포함", "패키지 비용": "160만 원", "계약금": "32만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["야외 촬영 옵션 제공", "앨범 업그레이드 할인", "가족 사진 추가 무료", "보정 서비스 포함"]}', 11, 51),
        (25, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/441303', 'COMPLETED', '{"날짜": "2025-03-34 11:00", "업체명": "벨라비스드레스", "위치": "서울특별시 강남구", "패키지": "스페셜 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 1벌", "피팅 횟수": "2회", "메이크업 포함 여부": "포함", "패키지 비용": "140만 원", "계약금": "28만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["야외 촬영 옵션 제공", "특정 날짜 예약 시 할인 혜택", "드레스 소품 무료 제공"]}', 11, 52),
        (26, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/930597', 'COMPLETED', '{"날짜": "2025-03-41 12:30", "업체명": "로얄드레스룸", "위치": "서울특별시 마포구", "패키지": "럭셔리 패키지", "드레스 종류": "본식 드레스 1벌, 촬영 드레스 1벌", "피팅 횟수": "4회", "메이크업 포함 여부": "포함", "패키지 비용": "120만 원", "계약금": "24만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["드레스 피팅 시 헤어 메이크업 무료", "촬영 원본 제공", "앨범 업그레이드 할인", "야외 촬영 옵션 제공"]}', 11, 53);
...
INSERT INTO audio_summaries (audio_summary_id, original_file_url, status, summary_result, customer_id, consultation_id)
VALUES
        (27, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/648191', 'COMPLETED', '{"날짜": "2025-02-22 12:00", "업체명": "정샘물 웨스트점", "위치": "서울특별시 용산구", "패키지": "본식 메이크업", "메이크업 스타일": "자연스러운 누드 메이크업", "헤어 스타일": "글램 웨이브", "패키지 비용": "50만 원", "계약금": "10만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["헤어 악세서리 무료 대여", "프리미엄 스킨케어 서비스 포함", "자연광 촬영 메이크업 최적화", "베이스 메이크업 업그레이드 제공"]}', 1, 69),
        (28, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/510228', 'COMPLETED', '{"날짜": "2025-02-29 13:00", "업체명": "이경민포레", "위치": "서울특별시 강남구", "패키지": "본식 메이크업", "메이크업 스타일": "자연스러운 누드 메이크업", "헤어 스타일": "내추럴 웨이브", "패키지 비용": "70만 원", "계약금": "14만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["신랑 메이크업 무료 포함", "수정 메이크업 서비스 제공", "자연광 촬영 메이크업 최적화"]}', 1, 70),
        (29, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/239224', 'COMPLETED', '{"날짜": "2025-02-36 13:00", "업체명": "샤인메이크업스튜디오", "위치": "서울특별시 서초구", "패키지": "신랑&신부 메이크업", "메이크업 스타일": "자연스러운 누드 메이크업", "헤어 스타일": "전통적인 업두", "패키지 비용": "30만 원", "계약금": "6만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["특정 날짜 예약 시 추가 할인", "신랑 메이크업 무료 포함", "수정 메이크업 서비스 제공", "신부 전용 맞춤 메이크업 컨설팅 제공"]}', 1, 71),
        (30, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/980659', 'COMPLETED', '{"날짜": "2025-02-43 12:00", "업체명": "살롱드로쉬", "위치": "서울특별시 용산구", "패키지": "촬영+본식 신부신랑 헤어메이크업", "메이크업 스타일": "클래식한 메이크업", "헤어 스타일": "우아한 업스타일", "패키지 비용": "50만 원", "계약금": "10만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["자연광 촬영 메이크업 최적화", "베이스 메이크업 업그레이드 제공", "메이크업 리허설 무료 제공", "신랑 메이크업 무료 포함"]}', 1, 72),
        (31, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/414576', 'COMPLETED', '{"날짜": "2025-03-50 13:30", "업체명": "정샘물 이스트점", "위치": "서울특별시 용산구", "패키지": "본식 메이크업", "메이크업 스타일": "클래식한 메이크업", "헤어 스타일": "내추럴 웨이브", "패키지 비용": "90만 원", "계약금": "18만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["자연광 촬영 메이크업 최적화", "특정 날짜 예약 시 추가 할인", "신부 전용 맞춤 메이크업 컨설팅 제공", "수정 메이크업 서비스 제공"]}', 1, 73),
        (32, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/903970', 'COMPLETED', '{"날짜": "2025-03-27 11:30", "업체명": "강동 웨딩 컨벤션", "위치": "서울특별시 서초구", "패키지": "신랑&신부 메이크업", "메이크업 스타일": "고급스러운 음영 메이크업", "헤어 스타일": "로맨틱 반업스타일", "패키지 비용": "90만 원", "계약금": "18만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["자연광 촬영 메이크업 최적화", "메이크업 리허설 무료 제공", "신랑 메이크업 무료 포함", "프리미엄 스킨케어 서비스 포함"]}', 11, 66),
        (33, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/430885', 'COMPLETED', '{"날짜": "2025-03-34 12:00", "업체명": "뷰티앤코", "위치": "서울특별시 마포구", "패키지": "본식 메이크업", "메이크업 스타일": "화사하고 러블리한 메이크업", "헤어 스타일": "로맨틱 반업스타일", "패키지 비용": "90만 원", "계약금": "18만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["수정 메이크업 서비스 제공", "프리미엄 스킨케어 서비스 포함", "신부 전용 맞춤 메이크업 컨설팅 제공", "메이크업 리허설 무료 제공"]}', 1, 67),
        (34, 'https://REMOVED.s3.REMOVED.amazonaws.com/audio/247256', 'COMPLETED', '{"날짜": "2025-03-41 13:30", "업체명": "루비웨딩메이크업", "위치": "서울특별시 강남구", "패키지": "본식 메이크업", "메이크업 스타일": "청순하고 맑은 메이크업", "헤어 스타일": "전통적인 업두", "패키지 비용": "30만 원", "계약금": "6만 원", "환불 규정": "1개월 전 100% 환불, 2주 전 50% 환불", "기타사항": ["메이크업 리허설 무료 제공", "프리미엄 스킨케어 서비스 포함", "신부 전용 맞춤 메이크업 컨설팅 제공", "베이스 메이크업 업그레이드 제공"]}', 1, 68);
